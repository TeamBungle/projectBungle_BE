...
public class ReportService {
    ...
    @Transactional
    public ResponseEntity<FinalResponseDto<?>> setUserReport(Long reporterId, Long badMannserId, String history) {
        ...
        Report report = new Report(reporterId, badMannserId,history);
